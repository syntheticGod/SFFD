...
#define NATIVE_RENDER_CLASS_NAME "com/gc/app/MyNativeRender"
#define NATIVE_BG_RENDER_CLASS_NAME "com/gc/app/egl/NativeEglRender"
...
JNIEXPORT void JNICALL native_RecoverConTrolPoints(JNIEnv *env, jobject instance)
{
     MyGLRenderContext::GetInstance()->recoverConTrolPoints();
}
#ifdef __cplusplus
}
#endif

//第二个参数时方法签名，见收藏，括号里为函数参数对应的类型签名，括号外为返回值对应的类型签名（这么做是因为java有函数重载）
static JNINativeMethod g_RenderMethods[] = {
		...
		{"native_RecoverConTrolPoints",      "()V",       (void *)(native_RecoverConTrolPoints)},
};
...
//使用动态方法注册，native放在g_RenderMethods一个native函数数组里
